...
if (isset($_POST['age'],$_POST['lieu_naissance'],$_POST['nationality'],$_POST['sexe'],$_POST['adresse'],$_POST['taille'],$_POST['poid'],$_POST['pied'],$_POST['position'],$_POST['position_secondaire'],$_POST['club'],$_POST['numero_license'],$_POST['historique_clubs'],$_POST['manager'],$_POST['contact_manager'])  AND !empty($_POST['age']) AND !empty($_POST['taille']) ) {
    ...
    $verification = $db->prepare('SELECT * FROM `jouers` WHERE (numero_licence = ?) OR (contact = ?)');
    $verification->execute(array($numero_license,$_SESSION['contact']));
    ...
    if ($nbr_verification === 0) {
        ...
        if ($enregistrement_joueur->execute(array($_SESSION['nom'],$_SESSION['prenom'],$age,$lieu_naissance,$taille,$poid,$position,$position_secondaire,$club,$numero_license,$historique_clubs,$pied,' ',$sexe,$manager,$contact_manager,$_SESSION['contact'],$_SESSION['reference'],'user.jpg',$nationality,$heure))) {
            ...
            $error_sub_form = 'error 500';
        }
        
    } else {
        $error_sub_form = 'licence ou telephone déjà enregister déjà ';
    }
            ...
            <div class="profile-picture-section form-section">
                ...
                <div class="profile-picture-preview">
                    ...
                    <label for="profile_picture" class="upload-btn"  style="color: red;">
                        ...
                        <input type="file" value="Importer" id="profile_picture" name="fichier" accept="image/*">
                    </label>
                </div>
             ...
             <fieldset class="form-section">
                ...
                <fieldset class="form-section">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <p style="color:red;text-align:center;"><?php echo $error_sub_form ?></p>
                        </div>
                    </div>
                </fieldset>
